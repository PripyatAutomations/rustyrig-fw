...
posix-install:
	...
	install -Dm644 res/rustyrig.png /usr/share/icons/hicolor/48x48/apps/rustyrig.png
	# Transform the .desktop shortcut to use $PREFIX
	sed rrgtk.desktop -e "s%/usr/local/%${PREFIX}%g" > ..tmp.rrgtk.desktop
	install -Dm644 ..tmp.rrgtk.desktop /usr/share/applications/rrgtk.desktop
	@${RM} -f ..tmp.rrgtk.desktop
