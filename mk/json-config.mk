...
USE_LIBMBEDTLS = $(strip $(shell cat ${CF} | jq -r '.features.libmbedtls'))
...
USE_PROFILING = $(strip $(shell cat ${CF} | jq -r '.features.profiling // "false"'))
...
${CF}:
	@echo "*******************************************************"
	@echo "* PLEASE read QUICKSTART.txt and edit ${CF} as needed *"
	@echo "*******************************************************"
	exit 1
