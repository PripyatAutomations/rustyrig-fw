...
#define HTTP_PING_TIME          60              // If we haven't heard from the client in this long, send a ping
...
#else
#define	HTTP_PING_TIMEOUT	10		// Ensure a minimum of 10 seconds wait for a reply
