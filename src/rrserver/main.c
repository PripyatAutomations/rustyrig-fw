...
defconfig_t defcfg[] = {
  ...
  { "debug.noisy_eeprom", "false",      "Extra debugging msgs from eeprom code?" },
  ...
  { "net.http.tls_bind", "127.0.0.1",   "Address to listen for HTTPS (TLS)" },
  { "net.http.tls_enabled", "false",    "Enable HTTPS (TLS) listener?" },
