...
sub generate_atu_tables_h {
   ...
   if (defined($atu)) {
      # Walk through the configured tuners
      for my $tuner (sort keys(%$atu)) {
         ...
         printf $fh "/***************************\n";
         printf $fh " * Tuner unit: $tuner config *\n";
         printf $fh " ***************************/\n";
         
         my $c = $atu->{$tuner}{C};
         my $l = $atu->{$tuner}{L};
         print $fh "   /* Capacitor values in pF */\n";
         print $fh "   static float atu_table_", $tuner, "_c[] = { ";
         foreach (@$c) {
            print $fh int($_), ", ";
         }
         print $fh "   };\n\n";
         print $fh "   /* Inductor values in uH */\n";
         print $fh "   static float atu_table_", $tuner, "_l[] = { ";
         foreach (@$l) {
            print $fh int($_), ", ";
         }
         print $fh "   };\n";
         printf $fh "/***************************\n";
         printf $fh " * End of unit $tuner config *\n";
         printf $fh " ***************************/\n";
      }
   #   die();
   } else {
