...
SZ_TTL=$((${SZ_C} + ${SZ_PL} + ${SZ_JS} + ${SZ_HTML} + ${SZ_CSS} + ${SZ_SH} + ${SZ_JSON}))

echo "LOC in $(basename $(pwd)): C ${SZ_C} Perl ${SZ_PL} JavaScript ${SZ_JS} HTML ${SZ_HTML} CSS ${SZ_CSS} BASH ${SZ_SH} JSON ${SZ_JSON} for a total of ${SZ_TTL} lines of s***!"
