...
echo "Lines of code in librustyaxe: C ${SZ_C_LRR}, librrprotocol: C ${SZ_C_LRP}, rrserver: C ${SZ_C_RRFW}, rrclient: C ${SZ_C_RRCLI}. WebUI: JavaScript ${SZ_JS}, HTML ${SZ_HTML}, CSS ${SZ_CSS}. BuildEnv: Perl ${SZ_PL}, Shell ${SZ_SH}, SQL ${SZ_SQL}. Grand Total of ${SZ_TTL} lines of unique code."
