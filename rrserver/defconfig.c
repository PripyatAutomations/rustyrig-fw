...
defconfig_t defcfg[] = {
   ...
   { "quota.enforce", "true", "Require PTT credits (ptt_credits table) for users to TX?" },
   { "quota.warning", "5", "Minutes of remaining PTT credits to send one-time low-credits notice" },
