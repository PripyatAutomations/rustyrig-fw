//
// rrgtk/gtk.fm-mode.c: FM mode dialog
...
GtkWidget *fm_dialog_create(void) {
   GtkWidget *w = NULL;

   w = gtk_window_new(GTK_WINDOW_TOPLEVEL);
   gtk_window_set_title(GTK_WINDOW(w), "FM Settings");
   gui_window_t *window_t = ui_new_window(w, "fm-mode");
