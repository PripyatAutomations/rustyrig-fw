...
# fwdsp raw-audio recorder uses libFLAC from its worker thread.
FWDSP_CFLAGS += $(shell pkg-config --cflags flac) -pthread
LDFLAGS_FWDSP += $(shell pkg-config --libs flac) -pthread
