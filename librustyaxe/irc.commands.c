...
const irc_command_t irc_commands[] = {
   { .name = "ERROR",   .desc = "ERROR response",                   .event_key = "irc.error", .cb = irc_builtin_error_cb },

   // --- Core client registration ---
   { .name = "PASS",    .desc = "Set connection password",          .cb = NULL },
   { .name = "NICK",    .desc = "Set/change nickname",              .event_key = "irc.nick", .cb = NULL, .relayed = true },
   ...
   { .name = "QUIT",    .desc = "Disconnect from server",           .event_key = "irc.quit", .cb = irc_builtin_quit_cb },
   ...
   { .name = "PING",    .desc = "Server keepalive ping",            .event_key = "irc.ping", .cb = irc_builtin_ping_cb },
